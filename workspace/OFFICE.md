...
| TradingSystems (Multi-Agent Trading Analysis Framework V1) | **เจ้าของ + Claude Code** ในโฟลเดอร์โปรเจค | Kwin / Pakin ช่วยตัดสินนิยามกฎเมื่อถูกถาม · กติกาอยู่ใน AGENTS.md + CLAUDE.md ในโฟลเดอร์ | **ห้าม agent เริ่มงานเอง** — ลงทะเบียนไว้เพื่องานตั้งเวลา/เฝ้าดูเท่านั้น |
